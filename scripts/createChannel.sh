...
createChannel() {
	...
	while [ $rc -ne 0 -a $COUNTER -lt $MAX_RETRY ] ; do
		sleep $DELAY
		set -x
		#While running on Linux based machine use -c as flag and for winfows use --channel-id
...
infoln "Joining uni peer to the channel..."
joinChannel 1
infoln "Joining mhrd peer to the channel..."
joinChannel 2
infoln "Joining thirdparty peer to the channel..."
joinChannel 3

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for uni..."
setAnchorPeer 1
